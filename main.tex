...
类似的情形可以延伸到两个随机变量. 请看下例: 

\begin{example}
    证明随机变量 $ X, Y , \mathbb{E}[X Y]^2 \leqslant \mathbb{E}\left[X^2\right] \mathbb{E}\left[Y^2\right]$
\end{example}
\begin{solution}
    我们使用均值不等式$a b \leqslant \frac{a^2+b^2}{2}$. 令$\tilde{X}=\frac{X}{\mathbb{E}\left[X^2\right]}, \tilde{Y}=\frac{Y}{\mathbb{E}\left[Y^2\right]}$
    
    <待补充>
\end{solution}

\paragraph{2. Markov不等式} 概率和期望之间有什么联系? 
\end{document}
