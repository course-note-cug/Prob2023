...
\begin{definition}
    ``事件$A$、$B$同时发生''
    称为事件$A$与$B$的\textbf{积}或\newword{交}{intersection}, 记作
    $$AB \ (\text{或}A\cap B)$$
